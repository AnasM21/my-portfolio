  ...
  return ( 
      <div name='home' className='w-full h-screen bg-[#0a192f]'>
          ...
          <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
              ...
              <p className='text-pink-600'>Hi My I am :</p>
              ...
              <p className='text-[#8892b0] py-4 max-w-[700px]'>who is passionate about working with data and making it alive to tell a story or help making decisions.
                  Currently I'm
                  looking for opportunities that will lead me to become a data engineer </p>
